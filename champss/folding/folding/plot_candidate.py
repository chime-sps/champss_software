...
def plot_candidate_archive(
    ...
    if max_beam is not None and "cfbm" in sys.modules:
        ...
        if arc_positions is not None:
            # Search for bright sources along the arc (within 0.5 degrees)
    ...
    # - Bright sources (sigma > 50): within 5 degrees or along the arc
    ...
    ks_positions_arc = []  # (ra, dec) for arc sources
    ...
    for source in all_sources:
        ...
        # Bright sources: 5-degree threshold or on arc; other sources: 1-degree threshold
