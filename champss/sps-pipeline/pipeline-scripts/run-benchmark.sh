...
multidayfold_pipeline --db-host sps-archiver1 --db-name sps_benchmark --foldpath ./benchmark/archives/ --datpath /data/chime/sps/raw_backup/ --start-date 20220618 --nday 4 --psr J2108+5000
